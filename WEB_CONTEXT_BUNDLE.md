...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-num-009-algebraic-number-normality-ab03bd16-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NUM-009"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-num-009-algebraic-number-normality-ab03bd16-v1",
      "problem_contract_sha256": "22845c562ec34b52183110c30f42bd5b2b27860de706bd61b3b52c3e44f1e40c",
      "problem_id": "problem:um-num-009-algebraic-number-normality-ab03bd16",
      "route_id": "route:um-num-009-algebraic-number-normality-ab03bd16-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-num-009-algebraic-number-normality-ab03bd16-source-fidelity-01",
      "graph_id": "graph:um-num-009-algebraic-number-normality-ab03bd16-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-num-009-algebraic-number-normality-ab03bd16-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-num-009-algebraic-number-normality-ab03bd16-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are all irrational algebraic numbers normal?"
          },
          "statement_sha256": "242c3a9d374062217c5eb83beecac0542ba07064026b1bace3761984b7c438ac"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-num-009-algebraic-number-normality-ab03bd16-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-num-009-algebraic-number-normality-ab03bd16-root",
      "route_id": "route:um-num-009-algebraic-number-normality-ab03bd16-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-num-009-62b75a986a85",
        "url": "https://www.unsolvedmath.com/problems/NUM-009"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
